...
export const BOSSES: Record<BossId, BossDef> = {
  sentinel: {
    ...
    w: 120,
    h: 44,
    taunt: 'Perimeter sealed',
    shielded: true,
    pushesFromStart: false,
    pushEvery: 9,
    gimmick: 'Hides behind bricks while the shield holds',
  },
  weaver: {
    id: 'weaver',
    name: 'Weaver',
    ...
    w: 104,
    h: 40,
    taunt: 'The web is already spun',
    // No shield: fast, exposed, and it starts weaving rows down immediately.
    shielded: false,
    pushesFromStart: true,
    pushEvery: 11,
    gimmick: 'No shield, but pushes rows down from the first second',
  },
  core: {
    id: 'core',
    name: 'Core',
    ...
    w: 150,
    h: 52,
    taunt: 'The reactor cannot be stopped',
    shielded: true,
    pushesFromStart: true,
    pushEvery: 7,
    gimmick: 'Shield plus constant row pressure',
  },
  doh: {
    id: 'doh',
    name: 'DOH',
    ...
    w: 168,
    h: 60,
    taunt: 'You came too far',
    shielded: true,
    nodeShield: true,
    pushesFromStart: true,
    pushEvery: 6,
    grabsBall: true,
    gimmick: 'Shield on power nodes, non-stop volleys, and grabs the ball late',
  },
};
