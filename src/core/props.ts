...
export const PROPS: Record<PropKind, PropDef> = {
  bumper: {
    ...
    radius: 15,
    score: 25,
    desc: 'Kicks the ball away with extra speed and pays out points',
  },
  sling: {
    kind: 'sling',
    name: 'Sling',
    ...
    radius: 14,
    score: 15,
    desc: 'Kicks the ball sideways — the angle turns unpredictable',
  },
  spinner: {
    kind: 'spinner',
    name: 'Spinner',
    ...
    radius: 13,
    score: 10,
    desc: 'The ball passes through and spins it, paying per turn',
  },
  target: {
    kind: 'target',
    name: 'Target',
    ...
    radius: 11,
    score: 50,
    desc: 'Drops on hit; knock them all down and a reward falls from above',
  },
  lock: {
    kind: 'lock',
    name: 'Lock',
    ...
    radius: 13,
    score: 30,
    desc: 'Swallows the ball and holds it; two locks send it back with company',
  },
};
